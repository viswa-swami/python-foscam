...
CAM_PASS = config_defaults.get('pass') or 'superuser'
CAM_WIFI_SSID = config_defaults.get('test_wifi_ssid') or ''
CAM_WIFI_PASS = config_defaults.get('test_wifi_pass') or ''
...
class TestFoscam(unittest.TestCase):
    ...
    def test_change_user_name(self):
        self.foscam.change_user_name('admin', 'testuser')
        self.foscam.usr = 'testuser'
        self.foscam.get_ip_info()
        self.foscam.change_user_name('testuser', 'admin')

    def test_change_password(self):
        self.foscam.change_password('admin', 'superuser', 'testpassword')
        self.foscam.pwd = 'testpassword'
        self.foscam.get_ip_info()
        self.foscam.change_password('admin', 'testpassword', 'superuser')
    ...
    def test_set_ip_info(self):
        ...
        self.foscam.set_ip_info(is_dhcp=0, ip='192.168.0.113',
